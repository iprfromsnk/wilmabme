...
typedef enum
{
  ...
  ***********************************/
  ...
  MACHWD_POST_TASK_TIME_LIMIT                       = 0x1ffb,
  MACHWD_RESET_TIME_LIMIT                           = 0x1ffc,
  MACHWD_SETHANDLER_ID_1_TIME_LIMIT                 = 0x1ffd,
  MACHWD_SETHANDLER_ID_2_TIME_LIMIT                 = 0x1ffe,
  MACHWD_SETHANDLER_ID_3_TIME_LIMIT                 = 0x1fff
} MacDbgCode_t;
