...
typedef struct _NWK_JoinConf_t
{
   ...
   * NWK_NOT_PERMITTED_STATUS, NWK_NO_NETWORKS_STATUS or any status value returned
   * from MLME-ASSOCIATE.confirm, MLME-SET.confirm, MLME-GET.confirm, 
...
typedef struct _NWK_JoinReq_t
{
  ...
  /* If the value of RejoinNetwork is 0x02 and this is TRUE than the device will try 
   * to rejoin securely. Otherwise, this is set to FALSE. */
  bool  securityEnable;
...
typedef struct _NWK_JoinInd_t
{
  ...
  bool  secureJoin;
  bool  isRejoin; /* TODO: it is deprecated. */
} NWK_JoinInd_t;
...
/**************************************************************************//**
  ...
  \param req - NLME-JOIN request parameters' structure pointer.
  \return none.
 ******************************************************************************/
...
/**************************************************************************//**
  ...
  \param ind - NLME-JOIN indication parameters' structure pointer.
  \return none.
 ******************************************************************************/
