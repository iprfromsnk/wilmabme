...
#if defined(ATMEGA1281) || defined(ATMEGA2561) || defined(ATMEGA1284) || defined(ATXMEGA128A1) || \
    defined(ATXMEGA256A3) || defined(AT90USB1287) || defined(ATMEGA128RFA1)
...
typedef struct
{
  ...
  volatile uint16_t rxBufferLength;
