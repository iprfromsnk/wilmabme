...
******************************************************************************/
uint16_t halSyncWriteData(uint16_t tty, uint8_t *buffer, uint16_t length);
...
******************************************************************************/
uint16_t halSyncReadData(uint16_t tty, uint8_t *buffer, uint16_t length);
...
Returns:
  none.
******************************************************************************/
INLINE void halCloseSpi(uint16_t tty)
{
...
Returns:
  none.
******************************************************************************/
INLINE void halEnableSpiDremInterrupt(uint16_t tty)
{
  UCSRnB(tty) |= (1 << UDRIE0);
}
...
Returns:
  none.
******************************************************************************/
INLINE void halDisableSpiDremInterrupt(uint16_t tty)
{
  UCSRnB(tty) &= ~(1 << UDRIE0);
}
...
Returns:
  none.
******************************************************************************/
INLINE void halEnableSpiTxcInterrupt(uint16_t tty)
{
  UCSRnB(tty) |=  (1 << TXCIE0);
}
...
Returns:
  none.
******************************************************************************/
INLINE void halDisableSpiTxcInterrupt(uint16_t tty)
{
  UCSRnB(tty) &=  ~(1 << TXCIE0);
}
...
Returns:
  none.
******************************************************************************/
INLINE void halEnableSpiRxcInterrupt(uint16_t tty)
{
  UCSRnB(tty) |= (1 << RXCIE0);
}
...
Returns:
  none.
******************************************************************************/
INLINE void halDisableSpiRxcInterrupt(uint16_t tty)
{
  UCSRnB(tty) &= ~(1 << RXCIE0);
}
#endif
